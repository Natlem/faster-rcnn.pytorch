...
def get_feat(alpha, frcnn_extra_ada, device, fasterRCNN, optimizer, is_break=False):
    ...
    for step in range(frcnn_extra_ada.s_iters_per_epoch):
        ...
        s_base_feat, s_pooled_feat = fasterRCNN.get_base_pooled_feat(src_im_data, src_im_info, src_gt_boxes, src_num_boxes)
        if s_tt_base_feat is None:
            s_tt_base_feat = s_base_feat
        else:
            s_tt_base_feat += s_base_feat

    for step in range(frcnn_extra_ada.t_iters_per_epoch):
        ...
        t_base_feat, t_pooled_feat = fasterRCNN.get_base_pooled_feat(tgt_im_data, tgt_im_info, tgt_gt_boxes, tgt_num_boxes)
        if t_tt_base_feat is None:
            t_tt_base_feat = t_base_feat
        else:
            t_tt_base_feat += t_base_feat
