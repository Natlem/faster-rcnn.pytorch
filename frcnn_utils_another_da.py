...
class FasterRCNN_prepare_another_da(FasterRCNN_prepare):
    def __init__(self, net, batch_size_train, s_dataset, t_dataset, cfg_file=None, debug=False):
        FasterRCNN_prepare.__init__(self, net, batch_size_train, s_dataset, cfg_file, debug=debug)
...
def train_frcnn_da(alpha, frcnn_extra_ada, device, fasterRCNN, optimizer, is_break=False):
